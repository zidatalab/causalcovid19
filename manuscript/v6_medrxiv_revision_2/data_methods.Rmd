...
kable(my_variables, caption = "Observed model variables", # landscape(
  ...
  pack_rows("Awareness", 10, 11) %>%
  pack_rows("Weather", 12, 15) %>%
  pack_rows("Interventions", 16, 19) %>%
  pack_rows("Socio-demographic", 20, 27) %>%
