...
# Load Data
modeldata <- bind_cols(read_csv("secondwave_analysis/data/Modeldata_scaled_pcamobility.csv"))

id_daycount <- read_csv("secondwave_analysis/data/Modeldata_raw.csv") %>%
...
pcaloadings <- read_csv("secondwave_analysis/data/pca_mobility_loadings.csv")
